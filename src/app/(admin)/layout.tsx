...
import { 
  ...
  RefreshCw, CheckCircle2, LineChart, X
} from "lucide-react";
...
export default function AdminLayout({
  ...
  const renderSidebarContent = (collapsed: boolean, isMobile: boolean = false) => (
    <>
      {/* Sidebar Header */}
      <div className={`h-16 flex items-center ${collapsed ? "justify-center px-2" : "justify-between px-5"} border-b border-gray-800/80 transition-all duration-300`}>
        ...
        {isMobile ? (
          ...
          <button 
            ...
            className={`p-1.5 rounded-lg text-gray-400 hover:text-white hover:bg-white/5 transition-colors cursor-pointer ${collapsed ? "hidden" : "block"}`}
          ...
          return (
            <Link
              ...
              className={`flex items-center ${
                collapsed ? "justify-center px-0 h-11" : "justify-between px-3 py-2.5"
      ...
      <div className="p-3 border-t border-gray-800/80 flex items-center justify-between">
        {!collapsed ? (
          ...
          <button 
            ...
            className="w-full flex items-center justify-center p-2 rounded-lg text-gray-400 hover:text-white hover:bg-white/5 transition-colors cursor-pointer"
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#090b10] text-gray-100 font-sans w-full">
      ...
      <aside 
        className={`fixed inset-y-0 left-0 z-50 w-72 bg-[#0c0e14] border-r border-gray-800 flex flex-col h-full transition-transform duration-300 ease-in-out select-none shadow-2xl lg:hidden ${
      ...
      <aside 
        ...
        } bg-[#0c0e14] border-r border-gray-800/70 flex-col flex-shrink-0 h-full transition-all duration-300 ease-in-out select-none relative z-20 shadow-xl`}
      >
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden bg-[#090b10]">
        ...
        <main className="flex-1 overflow-y-auto p-3 sm:p-6 lg:p-8 bg-gradient-to-b from-[#090b10] via-[#0d1017] to-[#090b10] w-full">
